...
# Azure PowerShell’e Genel Bakış
...
> [!NOTE]
> Dönüştürülemeyen klasik dağıtım modelini kullanan dağıtımlarınız varsa, Azure PowerShell'in Hizmet Yönetimi sürümünü yükleyebilirsiniz. Daha fazla bilgi için bkz.

[Azure PowerShell Service Management modülünü yükleme](/powershell/azure/servicemanagement/install-azure-ps).


<a id="need-help-with-powershell" class="xliff"></a>

### PowerShell konusunda yardıma mı ihtiyacınız var?
...
## Diğer Azure PowerShell modülleri
