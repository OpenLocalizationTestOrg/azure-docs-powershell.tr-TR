...
### <a id="update-azps"></a><span data-ttu-id="f5819-154">Azure PowerShell'in yeni bir sürümüne güncelleştirme</span><span class="sxs-lookup"><span data-stu-id="f5819-154">Updating to a new version of Azure PowerShell</span></span>
