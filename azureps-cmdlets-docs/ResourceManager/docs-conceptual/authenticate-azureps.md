---
title: "<span data-ttu-id=\"c50ee-101\">Azure PowerShell ile oturum açma</span><span class=\"sxs-lookup\"><span data-stu-id=\"c50ee-101\">Log in with Azure PowerShell</span></span>"
description: "<span data-ttu-id=\"c50ee-102\">Azure PowerShell ile oturum açma</span><span class=\"sxs-lookup\"><span data-stu-id=\"c50ee-102\">Log in with Azure PowerShell</span></span>"
services: azure
author: sdwheeler
ms.author: sewhee
manager: carmonm
...
---
# <span data-ttu-id="c50ee-103">Azure PowerShell ile oturum açma</span><span class="sxs-lookup"><span data-stu-id="c50ee-103">Log in with Azure PowerShell</span></span>
...
## <span data-ttu-id="c50ee-106">Etkileşimli oturum açma</span><span class="sxs-lookup"><span data-stu-id="c50ee-106">Interactive log in</span></span>
...
## <span data-ttu-id="c50ee-111">Hizmet sorumlusu ile oturum açma</span><span class="sxs-lookup"><span data-stu-id="c50ee-111">Log in with a service principal</span></span>
...
## <span data-ttu-id="c50ee-118">Başka bir bulut oturumu açma</span><span class="sxs-lookup"><span data-stu-id="c50ee-118">Log in to another Cloud</span></span>
...
## <span data-ttu-id="c50ee-123">Azure rol tabanlı erişimi yönetme hakkında daha fazla bilgi edinin</span><span class="sxs-lookup"><span data-stu-id="c50ee-123">Learn more about managing Azure role-based access</span></span>
