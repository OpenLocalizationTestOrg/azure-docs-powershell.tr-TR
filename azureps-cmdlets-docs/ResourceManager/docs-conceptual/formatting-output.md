...
| <span data-ttu-id="a6cf1-106">Biçimlendirme</span><span class="sxs-lookup"><span data-stu-id="a6cf1-106">Formatting</span></span>      | <span data-ttu-id="a6cf1-107">Dönüştürme</span><span class="sxs-lookup"><span data-stu-id="a6cf1-107">Conversion</span></span>       |
|-----------------|------------------|
...
<span data-ttu-id="a6cf1-111">Döndürülen sütunları sınırlamak isterseniz `Format-Table` cmdlet’ini kullanabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-111">If you would like to limit the columns returned you can use the `Format-Table` cmdlet.</span></span> <span data-ttu-id="a6cf1-112">Aşağıdaki örnekte, aynı sanal makine listesini alıyoruz ancak çıktıyı yalnızca VM’nin adı, kaynak grubu ve VM’nin konumu ile sınırlıyoruz.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-112">In the following example we get the same list of virtual machines but restrict the output to just the name of the VM, the resource group, and the location of the VM.</span></span>  <span data-ttu-id="a6cf1-113">`-Autosize` parametresi, sütunları veri boyutuna göre boyutlandırır.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-113">The `-Autosize` parameter sizes the columns according to the size of the data.</span></span>
...
<span data-ttu-id="a6cf1-114">İsterseniz bilgileri bir liste biçiminde görüntüleyebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-114">If you would prefer you can view information in a list format.</span></span> <span data-ttu-id="a6cf1-115">Aşağıdaki örnekte `Format-List` cmdlet’i kullanılarak bunun nasıl yapılacağı gösterilir.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-115">The following example shows this using the`Format-List` cmdlet.</span></span>
...
<span data-ttu-id="a6cf1-119">Çıktıyı JSON biçimine de dönüştürebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-119">You can also convert the output into JSON format.</span></span>  <span data-ttu-id="a6cf1-120">Aşağıdaki örnekte aynı VM listesi oluşturulur, ancak çıktı biçimi JSON olarak değiştirilir.</span><span class="sxs-lookup"><span data-stu-id="a6cf1-120">The following example creates the same list of VMs but changes the output format to JSON.</span></span>
